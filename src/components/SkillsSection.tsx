...
const SkillsSection = () => {
  ...
  return <section id="skills" className="min-h-screen flex items-center section-padding bg-secondary/20">
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:grid-cols-3 auto-rows-fr">
          ...
          <div className="col-span-1 md:col-span-2 row-span-2 bg-card rounded-xl shadow-lg glass-card animate-fade-in" style={{
          animationDelay: "0.1s"
        }}>
            <div className="p-6 md:p-8 h-full">
              <h3 className="text-xl font-semibold mb-6 text-gradient">Frontend Development</h3>
              <div className="space-y-6">
                {frontendSkills.map((skill, index) => <div key={skill.name} className="space-y-2" style={{
          ...
          {/* Backend Box */}
          <div className="col-span-1 row-span-1 bg-card rounded-xl shadow-lg glass-card animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
            <div className="p-6 md:p-8 h-full">
              <h3 className="text-xl font-semibold mb-4 text-gradient">Backend Development</h3>
              <div className="space-y-4">
                {backendSkills.map((skill, index) => <div key={skill.name} className="space-y-2" style={{
          ...
          {/* Other Skills Boxes */}
          {otherSkills.map((skill, index) => <div key={skill.name} className="col-span-1 bg-card rounded-xl shadow-lg glass-card animate-fade-in" style={{
